...
export default class SummaryService {
    openai;
    languageService;
    SUMMARY_SYSTEM_PROMPT = `You are a summarization assistant. Only use the conversation history provided to you. Do not reference or assume access to external knowledge or documents. Do not respond with explanations. Output only a valid JSON object that adheres to the schema below.
